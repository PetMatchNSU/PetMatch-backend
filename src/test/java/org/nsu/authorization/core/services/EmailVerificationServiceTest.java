...
class EmailVerificationServiceTest {
    ...
    void testVerifyEmail_Success() {
        when(jwt.getClaimAsString(JwtClaimKey.getUSER_ID())).thenReturn(TEST_USER_ID);
        when(jwt.getClaimAsString(JwtClaimKey.getUSER_EMAIL())).thenReturn(TEST_EMAIL);
    ...
    void testVerifyEmail_MissingUserIdClaim() {
        when(jwt.getClaimAsString(JwtClaimKey.getUSER_ID())).thenReturn(null);
        when(jwt.getClaimAsString(JwtClaimKey.getUSER_EMAIL())).thenReturn(TEST_EMAIL); // Still need this
    ...
    void testVerifyEmail_MissingEmailClaim() {
        when(jwt.getClaimAsString(JwtClaimKey.getUSER_ID())).thenReturn(TEST_USER_ID);
        when(jwt.getClaimAsString(JwtClaimKey.getUSER_EMAIL())).thenReturn(null);
    ...
    void testVerifyEmail_JwtClaimException() {
        when(jwt.getClaimAsString(JwtClaimKey.getUSER_ID())).thenThrow(new RuntimeException("Test JWT parsing error"));
    ...
    void testVerifyEmail_NonNumericUserId() {
        ...
        when(jwt.getClaimAsString(JwtClaimKey.getUSER_ID())).thenReturn(nonNumericUserId);
        when(jwt.getClaimAsString(JwtClaimKey.getUSER_EMAIL())).thenReturn(TEST_EMAIL);
