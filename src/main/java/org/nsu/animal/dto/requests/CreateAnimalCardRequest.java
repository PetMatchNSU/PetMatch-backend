...
@Getter
@Setter
@Schema(description = "Запрос на создание карточки животного")
public class CreateAnimalCardRequest {
    ...
    @Schema(description = "Кличка животного", example = "Барсик", required = true)
    private String name;

    @NotNull(message = "Вид животного обязателен для заполнения")
    @Schema(description = "Идентификатор вида животного", example = "1", required = true)
